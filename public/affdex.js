...
affdex.Detector = function() {
  ...
  // Name of events handled is <event>Failure or <event>Success
...
affdex.Detector.prototype.start = function() {
  if (!this.isRunning) {
    // Edited by Valentin
    var url = "./affdex-worker.js";
    XHRWorker(url, function(worker) {
      this.worker = worker;
...
/* Valentin 5/5/2020 NOT USING BELOW CODE */
